...
img1 = cv2.imread('2.jpg')[137:470, 327: 548, :]
img1 = cv2.resize(img1, (224, 224))/255
img1 = torch.tensor(img1, dtype=torch.float32)
img1 = torch.unsqueeze(img1, 0)
img1 = img1.permute(0, 3, 1, 2)
# o1 = model(img1)
img2 = cv2.imread('3.jpg')[113:475, 328:539, :]
# img2 = cv2.imread('5.jpg')[ 40:132, 210:270 , :]
# img2 = cv2.imread('4.jpg')[195:482, 382:541, :]
