...
# img = cv2.imread('/home/dung/AI/WIDER_train/6.jpg')
img = Image.open('/home/dung/AI/WIDER_train/6.jpg')
transform = torchvision.transforms.Compose([
        torchvision.transforms.Resize((224, 224)),
        torchvision.transforms.ToTensor(),
        torchvision.transforms.Normalize(
            [129.186279296875, 104.76238250732422, 93.59396362304688], [1, 1, 1])])
im = transform(img)
im = torch.unsqueeze(im,0)
model=vgg_vd_face_sfew_dag('/home/dung/AI/vgg_vd_face_sfew_dag.pth')
result=model(im)
print(model)
